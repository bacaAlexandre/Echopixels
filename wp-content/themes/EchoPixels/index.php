...
<!--    </div>-->
 ...
 <section class="bloc_blanc">
   <h1>Les objectifs de l'association</h1>
    <div class="wrapper">
        ...
        <div class="wrapper_droite">
            ...
            <p>Le métier de développeur web est en constante évolution. La formation continue est donc primordiale pour maintenir à jour ses connaissances.</p>
